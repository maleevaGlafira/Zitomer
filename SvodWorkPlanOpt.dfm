inherited frm_PlanWorkOpt: Tfrm_PlanWorkOpt
  Height = 362
  Caption = 'frm_PlanWorkOpt'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object gb_Attach: TGroupBox
    ...
    object chb_ObjVod: TCheckBox
      ...
      Width = 185
      Height = 17
      Caption = #1054#1041#1066#1045#1050#1058#1067' '#1042#1054#1044#1054#1055#1056#1054#1042#1054#1044#1040
      Checked = True
      State = cbChecked
      TabOrder = 2
    end
    object chb_ObjKan: TCheckBox
      ...
      Width = 177
      Height = 17
      Caption = #1054#1041#1066#1045#1050#1058#1067' '#1050#1040#1053#1040#1051#1048#1047#1040#1062#1048#1048
      Checked = True
      State = cbChecked
      TabOrder = 3
    end
