...
resourcestring
  ...
  SDeleteNotAllowed = 'Вам не разрешено удалять этот элемент';
  SMoveNotAllowed = 'Элемент %s не разрешено перемещать';
  ...
  SNoGetItemEventHandler = 'Не определен обработчик OnGetItem';
  SInvalidColorMap = 'Invalid Colormap this ActionBand requires ColorMaps of type TCustomActionBarColorMapEx';
  SDuplicateActionBarStyleName = 'Стиль с названием %s зарегистрирован';
