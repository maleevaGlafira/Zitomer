...
//  SBCDOverflow = '(Overflow)';
  ...
  SFieldNameTooLarge = 'Название поля %s превышает %d символов';
...
{ For SqlTimSt }
  ...
  SAbort = 'Прервать';
  SMerge = 'Слияние';
  SCorrect = 'Корректировать';
  SCancel  = 'Отменить';
  SRefresh = 'Обновить';
  SModified = 'Изменена';
  SInserted = 'Добавлена';
  SDeleted  = 'Удалена';
  SCaption = 'Ошибка обновления - %s';
  SUnchanged = '<Unchanged>';
  SBinary = '(Binary)';
  SAdt = '(ADT)';
  SArray = '(Array)';
  SFieldName = 'Имя поля';
  SOriginal = 'Оригинальное Значение';
  SConflict = 'Конфликтное Значение';
  SValue = ' Значение';
  SNoData = '<No Records>';
  SNew = 'Новый';    
